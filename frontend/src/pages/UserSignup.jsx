...
import EmailSignUpForm from "./signUpComponents/EmailSignUpForm";
        ...
        <div className="lg:flex lg:items-stretch lg:shadow-lg lg:rounded-xl lg:overflow-hidden">
          ...
          <div className="hidden lg:block lg:w-1/2 lg:bg-blue-600 lg:relative lg:p-8">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img
                src="https://images.unsplash.com/photo-1616432043562-3671ea2e5242?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3"
                alt=""
                className="absolute top-10 right-10 w-32 h-32 transform rotate-12"
              />
              <img
                src="https://images.unsplash.com/photo-1485575301924-6891ef935dcd?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3"
                alt=""
                className="absolute bottom-16 left-10 w-40 h-40"
              />
              <img
                src="https://images.unsplash.com/photo-1639598003276-8a70fcaaad6c?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3"
                alt=""
                className="absolute top-1/4 left-24 w-28 h-28"
              />
              <img
                src="https://images.unsplash.com/photo-1595475349262-88ba1e1eecaf?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3"
                alt=""
          ...
          <div className="bg-white lg:w-1/2 px-6 py-8 md:p-10 rounded-lg shadow-sm lg:shadow-none">
            ...
            <div className="relative z-10 space-y-4">
              {activeForm === "phone" ? (
                ...
                <EmailSignUpForm onBack={handleBackToOptions} />
              ) : (
                <>
